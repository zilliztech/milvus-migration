...
//
//	start := time.Now()
//	tasker := task.NewTaskSubmitter(task.NewBaseLoadTasker(cusFieldLoader, dp.jobId),
...
//}
//
//func (dp *Dumper) workESBatch(ctx context.Context, idxCfgs []*estype.IdxCfg, tasker *task.Submitter) error {
//
//	start := time.Now()
//	var g errgroup.Group
...
//}
//
//func (dp *Dumper) workInESMode(ctx context.Context, idxCfg *estype.IdxCfg, tasker *task.Submitter) error {
...
//}
//
//func (dp *Dumper) es2Json(ctx context.Context, idxCfg *estype.IdxCfg, tasker *task.Submitter) error {
//
...
//	channelSource *source.ChannelSource, tasker *task.Submitter) error {
//
